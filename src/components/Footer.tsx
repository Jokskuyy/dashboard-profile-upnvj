  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        <div className="absolute bottom-20 left-10 w-24 h-24 bg-purple-500/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">{t('universityShort')}</h3>
                <p className="text-blue-200 text-sm">Excellence in Education Since 1996</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 group">
                <div className="w-10 h-10 bg-blue-500/20 rounded-xl flex items-center justify-center border border-blue-400/30 group-hover:bg-blue-500/30 transition-colors">
                  <MapPin className="w-5 h-5 text-blue-300" />
                </div>
                <div>
                  <p className="text-white font-medium mb-1">Campus Address</p>
                  <p className="text-white/70 text-sm leading-relaxed">{t('footer.address')}</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-4 group">
                <div className="w-10 h-10 bg-green-500/20 rounded-xl flex items-center justify-center border border-green-400/30 group-hover:bg-green-500/30 transition-colors">
              ...
              <div className="flex items-start space-x-4 group">
                <div className="w-10 h-10 bg-purple-500/20 rounded-xl flex items-center justify-center border border-purple-400/30 group-hover:bg-purple-500/30 transition-colors">
              ...
              <div className="flex items-start space-x-4 group">
                <div className="w-10 h-10 bg-orange-500/20 rounded-xl flex items-center justify-center border border-orange-400/30 group-hover:bg-orange-500/30 transition-colors">
                  <Globe className="w-5 h-5 text-orange-300" />
                </div>
                <div>
                  <p className="text-white font-medium mb-1">Website</p>
                  <a href="https://upnvj.ac.id" className="text-white/70 text-sm hover:text-white transition-colors flex items-center">
                    upnvj.ac.id
