...
const CampusMapViewer: React.FC<CampusMapViewerProps> = ({
  ...
  const unityConfig = useMemo(
    () => ({
      dataUrl: `${basePath}unity-builds/V0.7.2/Build/V0.7.2.data.unityweb`,
      frameworkUrl: `${basePath}unity-builds/V0.7.2/Build/V0.7.2.framework.js.unityweb`,
      codeUrl: `${basePath}unity-builds/V0.7.2/Build/V0.7.2.wasm.unityweb`,
  ...
  useEffect(() => {
    ...
    const loadUnityBuild = async () => {
      ...
      try {
        ...
        const loaderUrl = `${basePath}unity-builds/V0.7.2/Build/V0.7.2.loader.js`;
