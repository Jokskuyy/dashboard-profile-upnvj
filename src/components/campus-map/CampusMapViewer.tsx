    ...
    return (
      ...
      >
        <div className="w-full max-w-3xl text-center text-white">
          ...
          />
          <h2 className="text-2xl font-bold sm:text-3xl">Pilih jenis denah kampus</h2>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <h3 className="text-xl font-bold">Denah 2D</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold">Denah 3D</h3>
              <p className="mt-1 text-sm text-green-100">
                {allow3D
