...
const UnityCampusMap: React.FC<CampusMapViewerProps> = ({
  isFullscreen = false,
  onToggleFullscreen,
}) => {
  ...
  const unityConfig = useMemo(
    () => ({
      dataUrl: `${basePath}unity-builds/v0.9.0/Build/v0.9.0.data.unityweb`,
      frameworkUrl: `${basePath}unity-builds/v0.9.0/Build/v0.9.0.framework.js.unityweb`,
      codeUrl: `${basePath}unity-builds/v0.9.0/Build/v0.9.0.wasm.unityweb`,
  ...
  useEffect(() => {
    ...
    const loadUnityBuild = async () => {
      ...
      try {
        ...
        const loaderUrl = `${basePath}unity-builds/v0.9.0/Build/v0.9.0.loader.js`;
