...
const UnityCampusMap: React.FC<CampusMapViewerProps> = ({
  ...
  const unityConfig = useMemo(
    () => ({
      dataUrl: `${basePath}unity-builds/v0.9.2/Build/V0.9.2.data.unityweb`,
      frameworkUrl: `${basePath}unity-builds/v0.9.2/Build/V0.9.2.framework.js.unityweb`,
      codeUrl: `${basePath}unity-builds/v0.9.2/Build/V0.9.2.wasm.unityweb`,
      streamingAssetsUrl: "StreamingAssets",
      companyName: "DefaultCompany",
      productName: "T_A",
      productVersion: "v0.9.2",
  ...
  useEffect(() => {
    ...
    const loadUnityBuild = async () => {
      ...
      try {
        ...
        const loaderUrl = `${basePath}unity-builds/v0.9.2/Build/V0.9.2.loader.js`;
