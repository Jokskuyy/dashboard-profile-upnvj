...
export const programData: ProgramData[] = [
  ...
  {
    id: "ft-s2-teknik-mesin",
    name: "S2 Teknik Mesin",
    level: "S2",
    faculty: "Fakultas Teknik",
    students: 120,
    color: "#93C5FD",
  ...
  {
    id: "fisip-s1-hubungan-internasional",
  ...
  {
    id: "fisip-s2-hubungan-internasional",
    name: "S2 Hubungan Internasional",
    level: "S2",
    faculty: "Fakultas Ilmu Sosial dan Politik",
    students: 120,
    color: "#F87171",
  ...
  {
    id: "fisip-s2-ilmu-politik",
    name: "S2 Ilmu Politik",
    level: "S2",
    faculty: "Fakultas Ilmu Sosial dan Politik",
    students: 60,
    color: "#FCA5A5",
  ...
  {
    id: "fikes-s1-kesehatan-masyarakat",
...
export const departmentData: DepartmentData[] = [
  // Fakultas Teknik
  {
    ...
    professors: 2,
    color: "#3B82F6",
    description: "Fokus pada konstruksi dan infrastruktur",
  },
  {
    id: "ft-teknik-mesin",
    name: "Teknik Mesin & Energi",
    faculty: "Fakultas Teknik",
    professors: 1,
    color: "#1D4ED8",
    description: "Termodinamika dan energi terbarukan",
  },
  {
    ...
    professors: 1,
    color: "#2563EB",
    description: "Sistem kontrol dan robotika",
  },
  {
    id: "ft-teknik-industri",
    name: "Teknik Industri & Manufaktur",
    faculty: "Fakultas Teknik",
    professors: 1,
    color: "#1E40AF",
    description: "Sistem produksi dan lean manufacturing",
  },
  {
    id: "ft-arsitektur",
    name: "Arsitektur & Perencanaan",
    faculty: "Fakultas Teknik",
    professors: 1,
    color: "#1E3A8A",
    description: "Desain sustainable dan urban planning",
  },
  {
    ...
    professors: 2,
    color: "#60A5FA",
    description: "Pengolahan air dan waste management",
  },

  // Fakultas Ekonomi dan Bisnis
  {
    id: "feb-manajemen",
    name: "Manajemen & Kewirausahaan",
    faculty: "Fakultas Ekonomi dan Bisnis",
    professors: 3,
    color: "#10B981",
    description: "Manajemen strategis dan bisnis digital",
  },
  {
    id: "feb-akuntansi",
    ...
    professors: 2,
    color: "#059669",
    description: "Akuntansi manajemen dan keuangan",
  },
  {
    id: "feb-ekonomi",
    ...
    professors: 1,
    color: "#047857",
    description: "Ekonomi makro dan regional",
  },
  {
    id: "feb-pemasaran",
    name: "Pemasaran & SDM",
    ...
    professors: 1,
    color: "#065F46",
    description: "Pemasaran digital dan manajemen SDM",
  },
  ...
  },
  {
    ...
    professors: 1,
    color: "#6D28D9",
    description: "Sistem database dan data mining",
  },
  {
    id: "fik-network",
    ...
    professors: 1,
    color: "#5B21B6",
    description: "Keamanan jaringan dan cybersecurity",
  },
  {
    id: "fik-multimedia",
    name: "Multimedia & Game",
    faculty: "Fakultas Ilmu Komputer",
    professors: 1,
    color: "#A78BFA",
    description: "Game development dan UI/UX",
  },
  {
    id: "fik-cloud",
    ...
    professors: 1,
    color: "#C4B5FD",
    description: "Cloud computing dan DevOps",
  },

  // Fakultas Hukum
  {
    id: "fh-hukum-pidana",
    name: "Hukum Pidana & Kriminologi",
    faculty: "Fakultas Hukum",
    professors: 1,
    color: "#F59E0B",
    description: "Hukum pidana dan acara pidana",
  },
  {
    id: "fh-hukum-perdata",
    name: "Hukum Perdata & Keluarga",
    faculty: "Fakultas Hukum",
    professors: 1,
    color: "#FBBF24",
    description: "Hukum kontrak dan keluarga",
  },
  {
    id: "fh-hukum-bisnis",
    name: "Hukum Bisnis & Internasional",
    faculty: "Fakultas Hukum",
    professors: 1,
    color: "#FCD34D",
    description: "Hukum bisnis dan internasional",
  },
  {
    id: "fh-hukum-tata-negara",
    name: "Hukum Tata Negara",
    faculty: "Fakultas Hukum",
    professors: 1,
    color: "#FDE68A",
    description: "Hukum administrasi dan good governance",
  },
  {
    id: "fh-hukum-lingkungan",
    name: "Hukum Lingkungan",
    faculty: "Fakultas Hukum",
    professors: 1,
    color: "#FEF3C7",
    description: "Hukum lingkungan dan sumber daya alam",
  },

  // Fakultas Ilmu Sosial dan Politik
  {
    id: "fisip-hubungan-internasional",
    name: "Hubungan Internasional",
    faculty: "Fakultas Ilmu Sosial dan Politik",
    professors: 1,
    color: "#EF4444",
    description: "Politik luar negeri dan diplomasi",
  },
  {
    id: "fisip-ilmu-politik",
    name: "Ilmu Politik & Demokrasi",
    faculty: "Fakultas Ilmu Sosial dan Politik",
    professors: 1,
    color: "#DC2626",
    description: "Demokrasi dan partai politik",
  },
  {
    id: "fisip-sosiologi",
    ...
    professors: 1,
    color: "#B91C1C",
    description: "Sosiologi dan masyarakat urban",
  },
  {
    id: "fisip-komunikasi",
    name: "Ilmu Komunikasi & Media",
    faculty: "Fakultas Ilmu Sosial dan Politik",
    professors: 1,
    color: "#991B1B",
    description: "Komunikasi massa dan media digital",
  },

  // Fakultas Ilmu Kesehatan
  {
    id: "fikes-kesehatan-masyarakat",
    name: "Kesehatan Masyarakat",
    faculty: "Fakultas Ilmu Kesehatan",
    professors: 1,
    color: "#06B6D4",
    description: "Epidemiologi dan biostatistik",
  },
  {
    id: "fikes-keperawatan",
    name: "Keperawatan",
    faculty: "Fakultas Ilmu Kesehatan",
    professors: 1,
    color: "#0891B2",
    description: "Keperawatan anak dan pediatric care",
  },
  {
    id: "fikes-gizi",
    name: "Ilmu Gizi & Nutrisi",
    faculty: "Fakultas Ilmu Kesehatan",
    professors: 1,
    color: "#0E7490",
    description: "Nutrisi klinis dan diet therapy",
  },
];
