...
replace_in_run(" (Node.js) dan konektivitasnya ke ", " (Supabase) dan konektivitasnya ke ")
...
# 4. Analytics
replace_in_run("sebuah modul analitik ", "sebuah integrasi analitik privacy-friendly menggunakan Umami ")

# 5. Multi-language
replace_in_run(" (React.js).", " (React.js) dengan fitur Multi-bahasa.")
...
doc.save(validate=False)  # Skipping validation to avoid unicode bug in validator print statement on windows
